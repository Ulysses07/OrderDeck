...
public sealed class AppHost : IDisposable
{
    ...
    public AppHost()
    {
        ...
        // CustomerSearchDialog / CustomerDetailDialog Faz 3'te çekmeceye döndü;
        // çekmeceler DI'dan ÇÖZÜLMÜYOR (fabrika + yukarıdaki ViewModel kaydı
        // yeterli).
        ...
        services.AddSingleton<Services.Sync.SessionOrderSyncService>(sp =>
            new Services.Sync.SessionOrderSyncService(
                sp.GetRequiredService<LicenseApiClient>(),

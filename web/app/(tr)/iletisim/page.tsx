...
export const metadata: Metadata = {
  title: 'İletişim',
  description: 'OrderDeck ekibine ulaşın — destek, satış ve geri bildirim.',
};
...
export default function ContactTr() {
  ...
  return (
    <>
      <Nav locale="tr" routeKey="contact" />
      <main className="mx-auto max-w-2xl px-5 py-16">
        ...
        <p className="mt-8 text-sm text-[var(--color-text-dim)]">
          <Link href={ROUTE_MAP.privacy.tr} className="text-[var(--color-accent)] hover:underline">

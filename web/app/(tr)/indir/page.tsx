...
export const metadata: Metadata = {
  title: 'İndir',
  description:
    'OrderDeck masaüstü uygulamasını Windows 10/11 için ücretsiz indir. ' +
    'Self-contained installer, kurulum sonrası ilk açılış sihirbazı seni 6 adımda yönlendirir.',
};

export default function DownloadTr() {
  const m = tr.downloadPage;

  return (
    <>
      <Nav locale="tr" routeKey="download" />
